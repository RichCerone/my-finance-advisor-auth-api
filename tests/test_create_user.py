...
from src.main import app, inject_jwt_bearer, Credentials, User, Token, JWTError, json, init_users_db, init_token_helper, init_bcrypt_helper, authorize_access
...
def init_bcrypt_helper_override_failure():
    bcrypt_helper_mock = Mock()
    bcrypt_helper_mock.get_password_hash.side_effect = Exception()
